...
const handleProuduct = ()=>{
  ...
  // Product Api Part Start 


  // Product Api Part End

  return (
    <>
    <div className="py-50 bg-categoriC">
    <Container>
          ...
          <div className="w-[65%]">
            <div className="flex items-center justify-between py-10">
              ...
              <Flex className={'flex-wrap gap-y-5'}>
                {apProduct.map((item)=>(
                    <div className="w-[32%]"><Product productTitle={item.title} productSrc={item.image} productPrice={item.price}/></div>
                )) }
              </Flex>
              </div>
